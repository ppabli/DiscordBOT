...
exports.meterCancion = async (bot, message, args) => {
	...
	if (serverQueue === undefined) {
		...
		return require("../musica/playlist").reproducir(bot, message);
...
exports.reproducir = (bot, message) => {
	...
	return serverQueue.dispatcher = serverQueue.connection.playStream(ytdl(serverQueue.songs[serverQueue.contador].url, {filter: 'audioonly'})).on('end', () => {require ("../musica/playlist").siguiente(bot, message)});
